...
Generated on 2026-05-26 with the built-in image generation tool.
...
### Rice Growth Stage Backgrounds

| Stage | File |
|---|---|
| 插秧期 | `assets/images/rice-stages/transplanting.png` |
| 分蘖期 | `assets/images/rice-stages/tillering.png` |
| 拔节期 | `assets/images/rice-stages/jointing.png` |
| 抽穗期 | `assets/images/rice-stages/heading.png` |
| 成熟收割期 | `assets/images/rice-stages/mature.png` |
...
| Name | File |
|---|---|
| 喷雾器（驱虫药液） | `assets/images/tools/insecticide-sprayer.png` |
| 捕虫网 | `assets/images/tools/net.png` |
| 粘虫板 | `assets/images/tools/sticky-board.png` |
| 杀菌喷雾器 | `assets/images/tools/fungicide-sprayer.png` |
| 除草耙 | `assets/images/tools/rake.png` |
| 病害清理铲 | `assets/images/tools/disease-shovel.png` |
